...
hidden if the `libraryproject_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `libraryproject_DEVELOPER_MODE` to the configure
